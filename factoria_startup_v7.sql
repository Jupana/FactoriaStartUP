...
CREATE TABLE `fsu_contribute` (
  ...
  KEY `IDX_F62FC043A76ED395` (`user_id`),
  CONSTRAINT `FK_F62FC0433342C72C` FOREIGN KEY (`contribute_project_id`) REFERENCES `fsu_projects` (`id`),
  CONSTRAINT `FK_F62FC043A76ED395` FOREIGN KEY (`user_id`) REFERENCES `fsu_users` (`id`)
...
INSERT INTO `fsu_contribute` VALUES (1,6,'Programación','Necesito a alguien que programe','2019-05-17 09:12:04',1),(2,7,'Programación','dfgfdsg','2019-05-17 12:38:31',1),(4,1,'Marketing','Alquine bueno en las Photoshop yes','2019-05-21 11:10:04',1),(5,1,'Legal','Experto en LPDO','2019-05-21 11:13:43',1),(6,1,'Financiero','Local','2019-05-21 15:23:31',1),(7,8,'Diseño','Necesito un UX/Designer','2019-05-24 12:16:59',3),(8,8,'Marketing','Alquine que lo promueva.','2019-05-24 12:28:03',3),(9,8,'Espacio Físico','Espacio','2019-05-24 13:56:56',3);
...
CREATE TABLE `fsu_needs_project` (
  ...
  KEY `IDX_E5484F70A76ED395` (`user_id`),
  CONSTRAINT `FK_E5484F70A76ED395` FOREIGN KEY (`user_id`) REFERENCES `fsu_users` (`id`),
...
INSERT INTO `fsu_needs_project` VALUES (1,6,'Diseño','% Ventas','20','Some Text',NULL,'2019-05-17 12:34:34',1),(2,7,'Diseño','% Ventas','10','dfgfdg',NULL,'2019-05-17 12:38:40',1),(3,1,'Financiero','Obra y Servicios','0','Te Pagare',NULL,'2019-05-21 10:40:22',1),(4,1,'Programación','Pacto a Futuro','0','Si todo va bine',NULL,'2019-05-21 17:23:19',1),(5,1,'Espacio Físico','% empresa','10','Nos quedamos alli',NULL,'2019-05-21 17:30:09',1),(7,1,'Financiación','% Ventas','2','jytu',NULL,'2019-05-22 13:49:16',1),(8,1,'Marketing','% Empresa','5','Te deare 5',NULL,'2019-05-22 16:07:49',1),(9,8,NULL,'% Empresa','5','Alquine que me assesore',NULL,'2019-05-24 12:17:24',3),(10,8,'Comercial','% Empresa','2','Si lo vendes tienes 2%',NULL,'2019-05-24 14:05:30',3);
...
INSERT INTO `fsu_profesional_profile` VALUES (1,'Muchos poyectos por hacer.\r\nNo existe el fracaso , solo un paso adelante.',0,1,'2019-05-20 09:22:02'),(2,'Descripcion Trabajo',0,3,'2019-05-24 10:42:57');
...
INSERT INTO `migration_versions` VALUES ('20190523074709','2019-05-23 07:48:12'),('20190523075406','2019-05-23 07:54:29'),('20190523075949','2019-05-23 08:00:04'),('20190524115516','2019-05-24 11:56:17'),('20190524115921','2019-05-24 11:59:37');
...
-- Dump completed on 2019-05-24 14:41:04
